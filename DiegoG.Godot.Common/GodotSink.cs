...
// Copied and modified from https://gist.github.com/paulloz/a0a01539ed96298682005ce61ba33a90

namespace DiegoG.Godot.Common;

public class GodotSink(string outputTemplate, IFormatProvider? formatProvider) : ILogEventSink
{
    private readonly TemplateRenderer formatter = new(outputTemplate, formatProvider);
